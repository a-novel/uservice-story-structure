...
func (_m *MockDeletePlotPoint) Exec(ctx context.Context, id uuid.UUID) (*entities.PlotPoint, error) {
...
//   - ctx context.Context
//   - id uuid.UUID
func (_e *MockDeletePlotPoint_Expecter) Exec(ctx interface{}, id interface{}) *MockDeletePlotPoint_Exec_Call {
	return &MockDeletePlotPoint_Exec_Call{Call: _e.mock.On("Exec", ctx, id)}
}

func (_c *MockDeletePlotPoint_Exec_Call) Run(run func(ctx context.Context, id uuid.UUID)) *MockDeletePlotPoint_Exec_Call {
...
func (_c *MockDeletePlotPoint_Exec_Call) RunAndReturn(run func(context.Context, uuid.UUID) (*entities.PlotPoint, error)) *MockDeletePlotPoint_Exec_Call {
	_c.Call.Return(run)
	return _c
}
